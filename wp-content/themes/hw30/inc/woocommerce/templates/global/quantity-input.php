...
if ( $max_value && $min_value === $max_value ) {
	...
	$label = esc_html__( 'Quantity', 'laurits' );
	?>
	<div class="qodef-quantity-buttons quantity">
		...
		<input
			type="<?php echo esc_attr( apply_filters( 'laurits_filter_woo_quantity_input_type', 'text' ) ); ?>"
			...
			title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'laurits' ); ?>"
			size="4"
