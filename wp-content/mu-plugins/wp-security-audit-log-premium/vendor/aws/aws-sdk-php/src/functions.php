...
function default_user_agent()
{
    ...
    // If Guzzle 6 or 7 installed
    if ($version === 6 || $version === 7) {
        return \WSAL_Vendor\GuzzleHttp\default_user_agent();
    }

    // If Guzzle 5 installed
    if ($version === 5) {
        return \WSAL_Vendor\GuzzleHttp\Client::getDefaultUserAgent();
    }
...
function guzzle_major_version()
{
    ...
    if (defined('\WSAL_Vendor\GuzzleHttp\ClientInterface::VERSION')) {
    ...
    } elseif (defined('\WSAL_Vendor\GuzzleHttp\ClientInterface::MAJOR_VERSION')) {
