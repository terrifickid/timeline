...
use Exception;
use WSAL_Vendor\GuzzleHttp\Client;
use WSAL_Vendor\GuzzleHttp\ClientInterface;
use WSAL_Vendor\GuzzleHttp\Event\EndEvent;
use WSAL_Vendor\GuzzleHttp\Exception\ConnectException;
use WSAL_Vendor\GuzzleHttp\Exception\RequestException;
use WSAL_Vendor\GuzzleHttp\Message\ResponseInterface as GuzzleResponse;
use WSAL_Vendor\GuzzleHttp\Promise;
use WSAL_Vendor\GuzzleHttp\Psr7\Response as Psr7Response;
use WSAL_Vendor\GuzzleHttp\Stream\Stream;
use WSAL_Vendor\Psr\Http\Message\RequestInterface as Psr7Request;
...
class GuzzleHandler
{
     ...
     * @throws \WSAL_Vendor\GuzzleHttp\Exception\GuzzleException
     */
