...
class WSAL_NP_Expression {
	 ...
	 * @return bool
	 */
	final protected function _evaluateTrigger( $condition ) {
		if ( empty( $condition ) ) {
			return false;
		}
		...
		$s4 = isset( $condition['select4'] ) && isset( $this->_s4_data[ $condition['select4'] ] ) ? $this->_s4_data[ $condition['select4'] ] : false;
		$s5 = isset( $condition['select5'] ) && isset( $this->_s4_data[ $condition['select5'] ] ) ? $this->_s5_data[ $condition['select5'] ] : false;
		$s6 = isset( $condition['select6'] ) && isset( $this->_s4_data[ $condition['select6'] ] ) ? $this->_s6_data[ $condition['select6'] ] : false;
		$s7 = isset( $condition['select7'] ) && isset( $this->_s4_data[ $condition['select7'] ] ) ? $this->_s7_data[ $condition['select7'] ] : false;
		$s8 = isset( $condition['select8'] ) && isset( $this->_s4_data[ $condition['select8'] ] ) ? $this->_s8_data[ $condition['select8'] ] : false;
