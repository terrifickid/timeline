...
if ( ! class_exists( 'WSAL_AS_Filters_ObjectWidget' ) ) {

	/**
	 * WSAL_AS_Filters_ObjectWidget.
	 */
	class WSAL_AS_Filters_ObjectWidget extends WSAL_AS_Filters_SingleSelectWidget {
		...
		protected function RenderField() {
			...
			<div class="wsal-widget-container">
				<select class="<?php echo esc_attr( $this->GetSafeName() ); ?>"
					...
					>
					<option value="" disabled selected hidden><?php esc_html_e( 'Select an Object to filter', 'wp-security-audit-log' ); ?></option>
					<?php
