...
if ( ! class_exists( 'WSAL_AS_Filters_UserRoleWidget' ) ) {

	/**
	 * WSAL_AS_Filters_UserRoleWidget.
	 *
	 * Class: IP Widget.
	 */
	class WSAL_AS_Filters_UserRoleWidget extends WSAL_AS_Filters_SingleSelectWidget {
		...
		protected function RenderField() {
			...
			<div class="wsal-widget-container">
				<select class="<?php echo esc_attr( $this->GetSafeName() ); ?>"
					...
					>
					<option value="" disabled selected hidden><?php esc_html_e( 'Select a user role to filter', 'wp-security-audit-log' ); ?></option>
					<?php
