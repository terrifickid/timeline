...
class StreamWrapper
{
     ...
     */
    public static function getResource(\WSAL_Vendor\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\WSAL_Vendor\Psr\Http\Message\StreamInterface $stream)
    {
